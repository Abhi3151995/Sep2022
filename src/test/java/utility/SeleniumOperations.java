...
try
{
	...
	String strkey=(String)inputParameters[1];
	 System.setProperty(strbrwsr,strkey);
...
public static Hashtable<String,Object> openApplication(Object[]inputParameters)
	...
	try
	{
		...
		outputParameters.put("STATUS", "PASS");
		outputParameters.put("MESSAGE", "methoduse: openApplication,Input Given: " +inputParameters[0].toString());
	}
	catch(Exception e)
	{
		outputParameters.put("STATUS", "FAIL");
